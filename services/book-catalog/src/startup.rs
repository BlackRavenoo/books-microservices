...
pub fn run(
    ...
    let constants_cache = Data::new(HybridCache::<String, ConstantsSchema, BitcodeSerializer<_>>::new(
        "constants".to_string(),
        redis_pool.clone(),
        1,
    ...
    let book_full_cache = Data::new(HybridCache::<String, BookFullSchema, BitcodeSerializer<_>>::new(
        "book-full".to_string(),
        redis_pool,
        50000,
        BitcodeSerializer::default()
